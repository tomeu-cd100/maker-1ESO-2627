# 🔁 Qüestionaris de repàs autocorrectius (SA0–SA9)
...
| SA | Tema | Preguntes |
|---|---|---|
| **SA0** | Seguretat i cultura maker | 8 |
| **SA1** | El clauer: Inkscape i làser | 8 |
| **SA2** | Disseny vectorial: el marcapàgines | 8 |
| **SA3** | Encaixos i procés tecnològic | 8 |
| **SA4** | Del 2D al 3D amb Tinkercad | 8 |
| **SA5** | Impressió 3D funcional | 8 |
| **SA6** | Disseny centrat en l'usuari | 8 |
...
### SA0 — Seguretat i cultura maker

1. Si veus fum estrany, una olor rara o algú es fa mal, què fas PRIMER?
   - Segueixo treballant, ja ho veurà algú.
...
1. Al nostre codi de colors, què vol dir cada color?
...
1. Vectoritzar una imatge vol dir…
   - Fer-la més gran.
...
1. Els eixos X, Y i Z representen…
   - Colors.
...
1. Laminar (amb Bambu Studio) vol dir…
   - Pintar el model.
...
1. Empatitzar, en disseny, vol dir…
...
1. El projecte final és integrador perquè…
   - És el més llarg.
