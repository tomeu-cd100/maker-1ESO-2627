...
- [ ] La peça és imprimible (gruixos i suports correctes).
- [ ] He laminat triant els paràmetres.
...
- Impressió 3D: filament (PLA), **laminat** amb Bambu Studio (alçada de capa, farciment,
  adherència, suports), temps i material.
...
1. **Repte + mesurar el problema (30')**: identificar la necessitat i prendre **mides reals**
   (regle/peu de rei) de l'objecte/espai on anirà la peça.
2. **Disseny a Tinkercad (80')**: modelar la peça amb les mides correctes; gruix mínim 2-3 mm.
3. **Diari (10')**.
...
fallida (pròpia o d'un altre equip) — l'error com a font d'aprenentatge.
...
## 8. Avaluació
- Disseny + impressió + funcionalitat: `Rubrica_SA5.md`. Diari/portafoli. Observació d'aula.
