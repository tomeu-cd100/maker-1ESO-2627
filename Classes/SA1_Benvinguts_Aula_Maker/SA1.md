...
4. **Normes i seguretat (35')**: lectura i comentari de `Normativa/Normes_seguretat_taller.md`.
   Elaboració del **contracte d'aula** i signatura.
...
## 8. Avaluació
- Observació (seguretat, actitud): `Avaluació/Full_seguiment_grup.md`.
- Diari de taller: `Avaluació/Diari_de_taller.md`.
- Producte i procés: `Rubrica_SA1.md`.
