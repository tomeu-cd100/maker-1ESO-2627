# SA8 — «Explorem la Realitat Virtual»
...
Després de consumir contingut immersiu (SA7), ara l'alumnat **crea** una experiència de
realitat virtual i n'aprèn l'ús segur, saludable i crític. Amb CoSpaces Edu construiran una
escena 3D que es pot explorar amb les ulleres VR.

> **Repte:** «Creeu en equip una **escena VR** (un petit museu, un recorregut temàtic o una
...
- **Atenció:** alternativa per a alumnat que no pugui/vulgui usar ulleres (visualització en
