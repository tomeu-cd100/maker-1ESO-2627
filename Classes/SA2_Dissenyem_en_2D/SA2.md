...
| **Nivell** | 1r ESO |
| **Trimestre** | 1r |
| **Temporització** | 3 sessions de 2 h (setmanes 4–6) |
...
Després del primer contacte, ara aprofundim en el **disseny vectorial**, l'eina clau per
fabricar a làser. Treballarem amb nodes, formes i text, i descobrirem com una imatge es
converteix en línies que la màquina pot tallar i gravar.
...
## 5. Producte final
Marcapàgines/etiqueta amb tall + gravat + imatge vectoritzada + missatge, documentat al diari.
