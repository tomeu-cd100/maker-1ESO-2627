# Rúbrica SA7 — «Captura el món en 360»

Nivells: **NA / AS / AN / AE**. Vegeu `Avaluació/Rubrica_general_competencial.md`.

| Criteri | NA | AS | AN | AE |
|---------|----|----|----|----|
| **Captura 360 (CA4.1)** | Encara no captura | Captures amb ajuda i defectes | Captures correctes i estables | Captures acurades (llum, enquadrament, neteja) |
...
| **Comunicació (CA5.3)** | Encara no presenta el tour | Confusa | Clara | Clara i atractiva |
