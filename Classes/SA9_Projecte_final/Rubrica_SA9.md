...
> 📌 **Signatura de peça:** al pla de projecte (sessió 1), cada membre queda responsable
> **identificable** d'una part de l'estand. Aquesta fila permet diferenciar nivells **dins del
> mateix equip**, creuant-la amb el diari i l'observació.
