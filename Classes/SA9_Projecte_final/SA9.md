...
> almenys **un objecte fabricat** (làser o 3D) i **una experiència immersiva** (360 o VR), i
> el presentareu a la Fira Aula Maker.»
...
fabricació 2D/3D, contingut immersiu, comunicació, seguretat, sostenibilitat i ètica.
...
2. **Coavaluació i votació de la galeria (20')**.
3. **Tancament de curs (30')**: portafoli final, autoavaluació global, valoració de l'optativa.

## 5. Producte final
Estand interactiu (objecte fabricat + experiència immersiva) presentat a la Fira + portafoli
final del curs.
