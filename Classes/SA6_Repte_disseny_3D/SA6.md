...
Tanquem el trimestre amb un repte de disseny **amb sentit social o lúdic**: l'alumnat treballa
en equip per resoldre un problema real d'algú (un company, una família, el centre) o per crear
un joc. És un projecte complet que combina empatia, disseny, fabricació i comunicació.

> **Repte:** «Trieu un dels reptes proposats i dissenyeu i imprimiu una **solució en 3D**:
> – Una **ajuda tècnica** (subjectar el llapis, obrir pots, organitzar material…).
...
- Modelatge 3D de diverses peces; conjunts i col·leccions (p. ex. peces d'un joc).
- Gestió de projecte i de la cua d'impressió en equip.
- Comunicació i defensa del projecte.
