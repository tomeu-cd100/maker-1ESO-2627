...
| 16 | SA4 | Repte de modelatge guiat + exportar STL | Producte SA4 |
| 17 | SA5 | Repte: dissenyar peça útil (mesures, requisits) | Requisits definits |
| 18 | SA5 | Modelatge 3D de la peça | Disseny STL |
| 19 | SA5 | Laminat amb Bambu Studio + inici impressió P2S | — |
| 20 | SA5 | Impressió, postprocés i avaluació | Producte SA5 |
| 21 | SA6 | Repte de disseny: problema real (ajuda tècnica/joc) | Repte triat |
| 22 | SA6 | Disseny i mesures | — |
| 23 | SA6 | Impressió i iteració | — |
...
- 📅 **Marge de final de curs (atenció):** la SA0 ocupa **2 setmanes** (la sessió de cohesió de
  ...
  la **Gran Fira és ara la setmana 35** (l'última): el juny porta imprevistos, així que la
  **vàlvula de seguretat** passa a ser la **sessió ⭐ d'ampliació VR de la SA8** i la
  **compressió de muntatge+assaig de la SA9** (setmanes 33-34), no un coixí propi. Si el
  calendari del centre ho permet, val la pena **guanyar una setmana** (36 en total) per
...
| **Setmana perduda** (festiu, sortida, vaga) | Sense coixí propi de juny (el consumeix la SA0 de 2 setmanes): la primera vàlvula és la **sessió ⭐ d'ampliació VR de la SA8**; si en cau una segona, les SA de 5 sessions **comprimeixen muntatge+assaig** (SA9, setmanes 33-34). Si es preveu més d'una pèrdua, negocieu una **36a setmana** amb prefectura d'estudis. |
