...
| **Setmana perduda** (festiu, sortida, vaga) | Sense coixí propi de juny (el consumeix la SA0 de 2 setmanes): la primera vàlvula real és **comprimir SA9** (fusionar muntatge+assaig, setmana 34) i, si en cau una segona, **fusionar les 2 sessions de SA8**. (La sessió ⭐ de SA8 no allibera temps: no ocupa setmana.) Si es preveu més d'una pèrdua, negocieu una **36a setmana** amb prefectura d'estudis. |
