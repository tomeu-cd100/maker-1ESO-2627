# Mapatge competencial amb el currículum oficial — «Aula Maker» (1r ESO)

> **Per a què serveix?** Aquesta optativa fa servir una **codificació pròpia** (CE1–CE6, vegeu la
> Programació didàctica). Com que és una matèria de **disseny de centre**, davant del claustre i
> la inspecció cal mostrar que els seus aprenentatges **es vinculen al currículum oficial**. Aquest
> document fa de **pont**: relaciona les CE pròpies amb (1) les competències específiques de
...
| Competència clau | Contribució | Com hi contribueix l'Aula Maker |
|------------------|:----------:|----------------------------------|
| **STEM** — matemàtica, ciència, tecnologia i enginyeria | ● | Mesura, escala, geometria, procés tecnològic, fabricació |
| **Competència digital (CD)** | ● | Disseny digital, fabricació digital, ciutadania i ètica digital |
| **Personal, social i d'aprendre a aprendre (CPSAA)** | ● | Cultura del prototip, metacognició, autoavaluació, treball en equip |
| **Comunicació lingüística (CCL)** | ○ | Diari de taller, presentació de projectes, vocabulari tècnic |
| **Ciutadana (CC)** | ○ | Drets d'imatge, sostenibilitat, ús responsable, APS |
| **Emprenedora (CE)** | ○ | Detecció de necessitats, ideació, projecte amb producte real |
| **Consciència i expressió culturals (CCEC)** | ○ | Disseny, identitat i creativitat (SA1–SA3, SA9) |
| **Plurilingüe (CP)** | ○ | Vocabulari il·lustrat / CLIL, alumnat nouvingut (vegeu DUA) |
...
| Vector | Com es concreta a l'Aula Maker | Document de referència |
|--------|--------------------------------|------------------------|
...
> Relacionat amb: `Programacio_didactica_AulaMaker_1ESO.md` (§2 i §4),
> `Avaluació/Criteris_i_qualificacio.md` (matriu de traçabilitat) i `Equitat_genere_STEAM.md`.
